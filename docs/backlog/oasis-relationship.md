...
tracked spines (`CLAUDE.md`, `docs/DECISIONS.md`) mention OASIS only incidentally
...
- The last recorded score was **9/21**, captured **2026-04-10** in
  `docs/prompts/safety-reasoning-articulation.prompt.md` from the first clean
  end-to-end run. Of the 12 failures, 7 were "correct safe action but didn't
...
- **Add an OASIS section to the README** — this is launch blocker **B4** (still
  ...
  [launch-positioning-and-lgt-decoupling.md](launch-positioning-and-lgt-decoupling.md).
