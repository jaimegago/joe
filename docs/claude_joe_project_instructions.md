This project uses a session-tracking convention that joins chat sessions to Claude Code sessions, commits, and decisions through a single slug. The full convention is specified in docs/pm-convention.md.
