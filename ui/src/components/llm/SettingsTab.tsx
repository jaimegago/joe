...
import { setActiveModel, setCostLimit, setRunawayCeiling } from '@/api/llm';
...
export function SettingsTab({ activeModel, costLimits, runawayCeiling, models }: SettingsTabProps) {
  return (
