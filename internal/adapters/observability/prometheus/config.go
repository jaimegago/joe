...
// Config holds Prometheus/Mimir adapter configuration.
type Config struct {
	URL    string `yaml:"url" json:"url"`         // Required: "http://prometheus:9090"
	OrgID  string `yaml:"org_id" json:"org_id"`   // Optional: Mimir multi-tenancy X-Scope-OrgID
